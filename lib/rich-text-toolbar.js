...
firepad.RichTextToolbar = (function(global) {
  ...
  RichTextToolbar.prototype.makeButton_ = function(eventName, iconName, iconType) {
    var self = this;
    var className;    
  ...
  RichTextToolbar.prototype.makeElement_ = function() {
    ...
    var toolbarOptions = [
      ...
      utils.elt('div', [
        ...
        self.makeButton_('highlight', 'magic')
      ], { 'class': 'firepad-btn-group'}),

      utils.elt('div', [
        self.makeButton_('unordered-list', 'list-2', 'firepad'), 
        self.makeButton_('ordered-list', 'numbered-list', 'firepad'),
        self.makeButton_('todo-list', 'list', 'firepad')
      ], { 'class': 'firepad-btn-group'}),

      utils.elt('div', [
        self.makeButton_('indent-decrease', 'outdent'), 
        lineHeight,
        self.makeButton_('indent-increase', 'indent')
      ], { 'class': 'firepad-btn-group'}),

      utils.elt('div', [
        self.makeButton_('left', 'align-left'),
        self.makeButton_('center', 'align-center'), 
        self.makeButton_('right', 'align-right')
      ], { 'class': 'firepad-btn-group'}),

      utils.elt('div', [
        self.makeButton_('undo', 'undo', 'firepad'), 
        self.makeButton_('redo', 'redo', 'firepad')
      ], { 'class': 'firepad-btn-group'})
    ];

    if (self.imageInsertionUI) {
      toolbarOptions.push(utils.elt('div', [self.makeButton_('insert-image', 'picture-o')], { 'class': 'firepad-btn-group' }));
    }
  ...
  RichTextToolbar.prototype.makeLineHeightDropdown_ = function() {
    ...
    return this.makeDropdown_('Spacing', 'line-height', items, '', 'text-height');
  };
