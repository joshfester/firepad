...
firepad.Firepad = (function(global) {
  ...
  Firepad.prototype.lineHeight = function(lineHeight) {
    this.richTextCodeMirror_.setAttribute(ATTR.LINE_HEIGHT, lineHeight);
    this.codeMirror_.focus();
  };
  ...
  Firepad.prototype.addToolbar_ = function() {
    ...
    this.toolbar.on('highlight', this.highlight, this);
    this.toolbar.on('line-height', this.lineHeight, this);
